...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Avem 4 cursuri principale: Street Dance (Hip-Hop, Dancehall, House, Waacking, Pop & Lock, MTV Commercial), KPOP Dance, Gimnastică acrobatică și Zumba pentru adulți. Fiecare curs se desfășoară pe 3 dificultăți (Începător, Intermediar, Avansat) și pe grupe de vârstă: Tiny (4–6), Junior (7–10), Varsity (11–14), Teens (15–19), Students (20–25), Adulți (>25).',
  },
  {
