const groups = [
  {
    ...
    color: '#f8ef21',
    textColor: '#231f20',
    courses: ['Gimnastică pentru cei mici', 'Dance & Play'],
  },
  {
    id: 'junior',
    label: 'Junior',
    ...
    color: '#231f20',
    textColor: '#ffffff',
    courses: ['Street Dance Junior', 'Gimnastică artistică'],
  },
  {
    id: 'varsity',
    label: 'Varsity',
    ...
    color: '#3a3637',
    textColor: '#ffffff',
    courses: ['Street Dance Varsity', 'KPOP Intro', 'Gimnastică'],
  },
  {
    id: 'teens',
    label: 'Teens',
    ...
    color: '#f8ef21',
    textColor: '#231f20',
    courses: ['Street Dance Advanced', 'KPOP', 'Performance'],
  },
  {
    id: 'students',
    label: 'Studenți',
    ...
    color: '#231f20',
    textColor: '#ffffff',
    courses: ['Dans Studenți', 'KPOP', 'Freestyle'],
  },
  {
    id: 'adults',
    label: 'Adulți',
    ...
    color: '#3a3637',
    textColor: '#ffffff',
    courses: ['Dans pentru adulți', 'Wellbeing & Movement'],
  },
]
