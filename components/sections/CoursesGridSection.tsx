...
const courses = [
  {
    ...
    title: 'Street Dance',
    desc: 'Hip-hop, breaking, popping, locking — dansul urban autentic. Toate grupele de vârstă, toate dificultățile.',
  ...
  },
  {
    ...
    desc: 'Flexibilitate, forță, eleganță. Metodologie completă pentru copii și adolescenți, în toate cele 3 dificultăți.',
