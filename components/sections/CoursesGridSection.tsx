...
const courses = [
  {
    ...
    title: 'Street Dance',
    desc: 'Hip-Hop, Dancehall, House, Waacking, Pop & Lock și MTV Commercial — dansul urban autentic, cu fundament din Jazz-Dance. Toate grupele de vârstă.',
    audience: 'Tiny → Adulți · 4–99 ani',
    tags: ['Începător', 'Intermediar', 'Avansat'],
    image: '/images/street-dance.webp',
  ...
  },
  {
    ...
    category: 'KPOP',
    title: 'KPOP Dance',
    desc: 'Coregrafii K-Pop oficiale, energie de grup, performance. De la pași simpli la coregrafii complete pe scenă.',
  ...
  },
  {
    ...
    desc: 'Elemente acrobatice, stând în mâini, salturi și flick-uri. De la 7 ani, cu antrenori licențiați FEFS și abordare 100% personalizată.',
    audience: 'Junior → Teens · 7–19 ani',
    tags: ['Începător', 'Intermediar', 'Avansat'],
  ...
  },
  {
    ...
    category: 'Zumba',
    title: 'Zumba (Adulți)',
    desc: 'Workout cu ritmuri latino, distractiv și intens. Fără presiune tehnică — doar energie pură și sănătate.',
    audience: 'Adulți · >25 ani',
    tags: ['Începător', 'Intermediar', 'Avansat'],
