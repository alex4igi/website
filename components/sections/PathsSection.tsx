...
const paths = [
  {
    ...
    label: 'Street Dance',
    title: 'Street Dance',
    desc: 'Hip-Hop, Dancehall, House, Waacking, Pop & Lock și MTV Commercial. Dansul urban autentic, pentru toate vârstele — de la Tiny la Adults.',
  ...
  },
  {
    ...
    desc: 'Forță, mobilitate, echilibru și trick-uri spectaculoase. Program structurat cu antrenori licențiați FEFS, pentru copii și adolescenți.',
