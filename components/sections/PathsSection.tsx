...
const paths = [
  {
    ...
    label: 'Street Dance',
    title: 'Street Dance',
    desc: 'Hip-Hop, Dancehall, House, Waacking, Pop & Lock și MTV Commercial. Dansul urban autentic, pentru toate vârstele — de la Tiny la Adulți.',
    age: 'Tiny → Adulți · 4–99 ani',
    accent: '#f8ef21',
    accentText: '#231f20',
  ...
  },
  {
    ...
    desc: 'Elemente acrobatice, stând în mâini, salturi și flick-uri. De la 7 ani în sus, cu antrenori licențiați FEFS.',
    age: 'Junior → Teens · 7–19 ani',
    accent: '#3a3637',
    accentText: '#f8ef21',
